...
\noindent
এই অধ্যায়ে সবচেয়ে বেশি লাগবে ১২ নম্বর অধ্যায়ের অক্ষের ঘূর্ণন এবং
৭ নম্বর অধ্যায়ের কোসাইন সূত্র; ১১ নম্বর অধ্যায়ের ত্রিমাত্রিক
জ্যামিতিও কাজে লাগবে। ক্যালকুলাস এখানে প্রায় লাগবেই না, কিন্তু ২১ নম্বর
অধ্যায়ে ভেক্টর ও ক্যালকুলাস একসঙ্গে আসবে, তাই ১৫ ও ১৭ নম্বর অধ্যায়
...
দুই মাত্রায়, ১২ নম্বর অধ্যায় অনুযায়ী অক্ষ $\theta$ কোণে ঘোরালে
\[
...
\[
  ...
  = \sqrt{A_{x}^{2}+A_{y}^{2}} .
\]
১২ নম্বর অধ্যায়ে সাধারণভাবে প্রমাণ করা হয়েছিল যে ঘূর্ণনে $x^{2}+y^{2}$
...
\[
  \mathbf{A} = A_{x}\hat{\mathbf{x}} + A_{y}\hat{\mathbf{y}}
             + A_{z}\hat{\mathbf{z}} ,
\]
এবং ১১ নম্বর অধ্যায়ের ত্রিমাত্রিক Pythagoras অনুযায়ী
\[
...
রূপটি ব্যবহার করা হবে, কারণ ২১ নম্বর অধ্যায়ে অন্য স্থানাঙ্কেও একক ভেক্টর
...
দুটি ভেক্টরের যোগফলের মান বের করতে ৭ নম্বর অধ্যায়ের কোসাইন সূত্র লাগে।
...
\begin{remark}
৯ নম্বর অধ্যায়ে ত্রিভুজ অসমতা প্রমাণ করে বলা হয়েছিল যে এটি ২০ নম্বর
অধ্যায়ে ভেক্টর আকারে ফিরে আসবে। এসেছে:
\[
  |\mathbf{A}+\mathbf{B}| \leq |\mathbf{A}| + |\mathbf{B}| .
\]
উপরের সূত্র থেকেই দেখা যায়, কারণ $\cos\theta \leq 1$, তাই
$|\mathbf{A}+\mathbf{B}|^{2} \leq A^{2}+B^{2}+2AB = (A+B)^{2}$। সমতা ঘটে
কেবল $\theta = 0$-এ, অর্থাৎ দুটি ভেক্টর একই দিকে থাকলে; ৯ নম্বর অধ্যায়ে
...
ভেক্টরটির দৈর্ঘ্য দুইভাবে লিখি। একদিকে কোসাইন সূত্র (৭ নম্বর অধ্যায়):
\[
...
যা চেনা কথা। ২১ নম্বর অধ্যায়ে flux $\mathbf{E}\cdot d\mathbf{A}$ একই
ধারণা।

\begin{remark}
৯ নম্বর অধ্যায়ের আরেকটি ধার এখানে শোধ হয়। সেখানে কোশি-শোয়ার্জ অসমতা
$\left( \sum a_{i}b_{i} \right)^{2} \leq \left( \sum a_{i}^{2} \right)
\left( \sum b_{i}^{2} \right)$ প্রমাণ করে বলা হয়েছিল যে ২০ নম্বর
অধ্যায়ে এর আসল চেহারা ধরা পড়বে। এখন স্পষ্ট: বাম পাশ
...
\sqrt{\sum B_{i}^{2}}$, অর্থাৎ ৯ নম্বর অধ্যায়ের অসমতা।

সমতা ঘটে যখন $|\cos\theta| = 1$, অর্থাৎ $\theta = 0$ বা $180^{\circ}$,
অর্থাৎ দুটি ভেক্টর সমান্তরাল। ৯ নম্বর অধ্যায়ে শর্তটি লেখা হয়েছিল
...
অধ্যায়ে ভেক্টর ক্ষেত্র নিয়ে কাজ করার সময় এই লেখার ভঙ্গিটাই সুবিধা দেবে।
\end{remark}
