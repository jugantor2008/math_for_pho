...
\noindent
এই অধ্যায়ের ভিত্তি ১৬ নম্বর অধ্যায়: $dy = f'(x)\,dx$, differential
আকারে chain rule, এবং $dm$, $dA$, $dV$ ধরনের ক্ষুদ্র উপাদান। ১৫ নম্বর
অধ্যায়ের derivative-এর তালিকাটি সারাক্ষণ হাতের কাছে লাগবে, আর ১৩ নম্বর
অধ্যায়ের অর্ধ কোণের সূত্রটি তৃতীয় অনুচ্ছেদে একবার লাগবে।

১৬ নম্বর অধ্যায় শেষ হয়েছিল একগুচ্ছ অসমাপ্ত বাক্য দিয়ে: দণ্ডের ভর, চাকতির
জড়তার ভ্রামক, গোলকের ভর, প্রতিটির জন্য $dm$ লেখা হয়েছিল আর বলা হয়েছিল ``যোগ
করার কাজটি ১৭ নম্বর অধ্যায়ের''। এই অধ্যায়ে সেই যোগগুলো করা হবে।
...
আর $dx$ হলো ১৬ নম্বর অধ্যায়ের তৃতীয় পাঠ: এক টুকরোর প্রস্থ। সব মিলিয়ে
...
ধর্মগুলো তো আমরা চিনিই; limit নিলেও তারা টেকে (১৪ নম্বর অধ্যায়ের limit-এর
নিয়ম)।
...
\]
যেখানে শেষ ধাপে ৮ নম্বর অধ্যায়ের যোগফল ব্যবহার করা হয়েছে। সরল করে
\[
...
\begin{enumerate}
  ...
  \item $x^{3}$ একটি অড ফাংশন (১০ নম্বর অধ্যায়), আর ব্যবধিটি
        মূলবিন্দু সাপেক্ষে প্রতিসম। বাম অর্ধেকের চিহ্নযুক্ত ক্ষেত্রফল ডান
        অর্ধেকের ঠিক ঋণাত্মক, তাই যোগফল শূন্য: $\int_{-2}^{2}x^{3}dx = 0$।
\end{enumerate}
তৃতীয়টিই ১০ নম্বর অধ্যায়ে প্রতিসাম্য নিয়ে যে কথাটি বলা হয়েছিল তার
নির্ভুল রূপ।
\end{sol}
...
(১৪ নম্বর অধ্যায়) অনুযায়ী মাঝেরটিও $f(x)$-এ যায়, অর্থাৎ $F'(x) = f(x)$।

(এখানে ধরে নেওয়া হয়েছে যে বদ্ধ ব্যবধিতে continuous ফাংশনের সর্বনিম্ন ও
সর্বোচ্চ মান সত্যিই থাকে। এটি একটি উপপাদ্য, যার প্রমাণ ১৪ নম্বর অধ্যায়ের
...
ধ্রুবক (এই ফলটির প্রমাণে Mean Value Theorem লাগে, যা ১৫ নম্বর অধ্যায়ের
...
থাকে। ১৫ নম্বর অধ্যায়ের derivative-এর তালিকাটি উল্টো দিক থেকে পড়লেই
...
\begin{example}
১৬ নম্বর অধ্যায়ের দণ্ডটির হিসাব শেষ করো: $x = 0$ থেকে $L$ পর্যন্ত
...
\prob{3} ১৬ নম্বর অধ্যায়ের দণ্ডটির জন্য ($\lambda = \lambda_{0}(1+x/L)$)
...
\prob{3} ১৫ নম্বর অধ্যায়ের কণাটির বেগ $v(t) = 3t^{2} - 12t + 9$।
\begin{enumerate}
...
১৬ নম্বর অধ্যায়ের নিয়ম উল্টো দিক থেকে পড়ে পাওয়া।
...
এটি chain rule-এরই উল্টো পাঠ। ১৬ নম্বর অধ্যায়ে বলা হয়েছিল যে differential
...
বীজগণিতটা লম্বা হয় (এসব ক্ষেত্রে কীভাবে আংশিক ভগ্নাংশ বের করতে হয় তার নিয়মগুলো নবম-দশম শ্রেণির উচ্চতর গণিত বিষয়ের বইয়ে পাবে)।
...
(গ) সরাসরি antiderivative নেই, তাই আগে ১৩ নম্বর অধ্যায়ের অর্ধ কোণের সূত্র
...
এবার ১৬ নম্বর অধ্যায়ের কায়দাটি নতুন একটি রাশিতে প্রয়োগ করি। প্রশ্ন:
...
\]
Polar স্থানাঙ্কে বাহু দুটি $dr$ ও $r\,d\theta$ (১৬ নম্বর অধ্যায়), তাই
\[
...
\begin{enumerate}
  ...
  \item Chain rule প্রয়োগ করে $\dfrac{dy}{dx} = \sinh\dfrac{x}{a}$। ১০ নম্বর
        অধ্যায়ে প্রমাণিত হয়েছিল $\cosh^{2}u - \sinh^{2}u = 1$, তাই
        \[
...
এখানে থেমে একবার পেছনে তাকাও। ১১ নম্বর অধ্যায়ে গোলক ও cone-এর আয়তন বের
করা হয়েছিল ``প্রতিটি উচ্চতায় প্রস্থচ্ছেদ সমান হলে আয়তনও সমান'' এই নীতিটি
ধরে নিয়ে, আর বলা হয়েছিল যে ১৭ নম্বর অধ্যায়ে এটি এক লাইনে বেরিয়ে আসবে।
...
\]
১১ নম্বর অধ্যায়ে এই ফলটি প্রস্থচ্ছেদের নীতি ধরে নিয়ে পাওয়া গিয়েছিল; এবার
...
নির্ণয় করো, এবং ১১ নম্বর অধ্যায়ের ফলের সঙ্গে মেলাও।
...
\[
  V = \frac{\pi r^{2}}{h^{2}}\int_{0}^{h}x^{2}dx
    ...
    = \frac{1}{3}\pi r^{2}h .
\]
১১ নম্বর অধ্যায়ে ঘনককে তিনটি pyramid-এ কেটে এবং প্রস্থচ্ছেদের নীতি ধরে
নিয়ে একই $\tfrac{1}{3}$ পাওয়া গিয়েছিল। সেখানে যা ধরে নিতে হয়েছিল, এখানে
তা প্রমাণ হলো।
\end{sol}

\prob{3} ১৬ নম্বর অধ্যায়ের চাকতির হিসাব শেষ করো। $R$ ব্যাসার্ধের একটি
...
\[
  I = \frac{1}{2}MR^{2} .
\]
১৬ নম্বর অধ্যায়ে যে উত্তরটির কথা বলা হয়েছিল, সেটিই পাওয়া গেল।
\end{sol}

\prob{4} ১৬ নম্বর অধ্যায়ের গোলকটির হিসাব শেষ করো। $R$ ব্যাসার্ধের নিরেট
